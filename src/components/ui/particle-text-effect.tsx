...
const DEFAULT_WORDS = ["CAMPUS", "INSIGHTS", "EXCELLENCE", "INNOVATION", "FUTURE"]
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black p-4">
      ...
      <div className="mt-6 text-center max-w-md">
        <p className="mb-2 text-xl font-bold" style={{ color: "#C9A96E" }}>Campus Insights Particle Effect</p>
